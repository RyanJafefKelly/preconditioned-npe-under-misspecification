...
GROUP="th_$(printf 'k%s_lam%s' "${THETA_ARR[@]}")-n_obs_${N_OBS}-obs_${OBS_MODEL}-eps_${EPS}-n_sims_${N_SIMS}-q_${Q_PRECOND}"
OUTDIR="results/contaminated_weibull/pnpe_rs/${GROUP}/seed-${SEED}/${DATE}"
mkdir -p "$OUTDIR"
