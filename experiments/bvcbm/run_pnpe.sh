...
GROUP="th_${THETA_TAG}-T_${T}-sum_${SUMMARY}-page_${PAGE}-obs_${OBS_MODEL}-pre_${PRECOND_METHOD}-q_${Q_PRECOND}-n_sims_${N_SIMS}"
OUTDIR="results/bvcbm/pnpe/${GROUP}/seed-${SEED}/${DATE}"; mkdir -p "$OUTDIR"
