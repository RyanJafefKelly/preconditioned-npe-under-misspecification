...
GROUP="th_${THETA_TAG}-T_${T}-sum_${SUMMARY}-page_${PAGE}-obs_${OBS_MODEL}-n_sims_${N_SIMS}-q_${Q_PRECOND}-rfabc_${RF_TAG}"
OUTDIR="results/bvcbm/prnpe/rf_abc/${GROUP}/seed-${SEED}/${DATE}"; mkdir -p "$OUTDIR"
