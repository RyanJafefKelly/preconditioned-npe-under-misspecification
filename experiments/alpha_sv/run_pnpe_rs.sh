...
GROUP="th_${THETA_TAG}-T_${T}-th1_${THETA1}-obs_${OBS_MODEL}-n_sims_${N_SIMS}-q_${Q_PRECOND}-mmd_${MMD_TAG}"
OUTDIR="results/alpha_sv/pnpe_rs/${GROUP}/seed-${SEED}/${DATE}"; mkdir -p "$OUTDIR"
